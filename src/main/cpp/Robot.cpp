...
void Robot::RobotInit() {
	...
	trencher.GetConfigurator().Apply(configs);
	hopper_belt.GetConfigurator().Apply(configs);
	...
	this->AddPeriodic(std::bind(&Robot::periodic_handle_serial_control, this), 1_ms);
